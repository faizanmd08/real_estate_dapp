...
const Home = ({ home, provider, account, escrow, togglePop }) => {
  ...
  const buyHandler = async () => {
    ...
    const contractBuyer = await escrow.buyer(home.id);

    console.log(contractBuyer);

    console.log(account);
    // Check if the connected account is the buyer
    if (account !== contractBuyer) {
      alert("You are not the buyer of this property!");
      return;
    }
